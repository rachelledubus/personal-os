...
const RESOLVE_ACTIONS = [
  ...
  { key: 'content', label: 'Content idea', fn: resolveToContentItem, destLabel: 'Business → Flows', destLink: '/business/flows' },
  { key: 'contact', label: 'Opportunity', fn: resolveToContact, destLabel: 'Business → Contacts',
    destLink: (record) => `/business/contacts/${record.id}` },
