    ...
    <div>
      ...
      <Card>
        <div className="row-between">
          ...
          <input type="date" value={planDate} onChange={e => setPlanDate(e.target.value)} style={{ maxWidth: 160 }} />
        </div>
      ...
      {MEAL_TYPES.map(mt => (
        <Card key={mt} style={{ marginTop: 'var(--space-4)' }}>
          ...
          <div className="food-quick-add-row">
      ...
      <div className="row meal-planner-actions" style={{ marginTop: 'var(--space-4)' }}>
      ...
      {planDate === todayStr() && (
        <Card style={{ marginTop: 'var(--space-5)' }}>
          ...
          <div className="row-between" style={{ fontSize: 14, flexWrap: 'wrap' }}>
